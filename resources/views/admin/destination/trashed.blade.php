...
@section('title','Điểm đến tạm xóa')
@section('main')
<div class="card">
    <div class="card-body">
        ...
        <form action="" method="GET" class="form-inline">
            ...
            <div class="form-group ml-auto">
                <a href="{{route('destination.forcedeleteAll')}}" class="btn btn-danger btn-delete-all  mr-1"><i class="fas fa-trash mr-1"></i>Xóa
                    Lựa
                    chọn</a>
                    <a href="{{route('destination.restoreAll')}}" class="btn btn-success btn-restore-all  mr-1"><i class="fas fa-window-restore mr-1"></i>Khôi phục
                    Lựa
                    chọn</a>
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            <a href="{{route('destination.restore',$data->id)}}" class="btn btn-success mr-1">
